...
<head>
  ...
  <link rel="stylesheet" href="<c:url value="/resources/css/font-awsome.min.css"/>">
  <link rel="stylesheet" href="<c:url value="/resources/css/prism-okiaidia.css"/>">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" id="download">Cerulean <span class="caret"></span></a>
